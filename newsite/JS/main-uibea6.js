// Copyright Data Design Group, Inc. 2018 - 2023 All Rights Reserverd.
...
function handleFileSelect(evt) {
    ...
    if (fn.toLowerCase().endsWith(".pdf")) {
        if(document.getElementById('f2')) {
           ...
           document.getElementById('f2').dispatchEvent(e);
        }
        return;
    }
    ...
    reader.onload = function(event) {            
         ...
         if(document.getElementById('txt1'))document.getElementById('txt1').value=data;
         else if(document.getElementById('f1'))document.getElementById('f1').files[0] = files[0];
         ...
         if (typeof setupSortDD === "function")setupSortDD();
    }
    var encoding="";
...
function loadForm(s,csv)
{
   ...
   ddgFormSerializer.restoreForm(frms,
           function(fldObj)
           {
               if (fldObj.id === "txt1" && document.getElementById('chkIgnoreDoubleQuote')) {
                   parseAndOptions(CSV);
                   if (typeof setupSortDD === "function")setupSortDD();
               }
           }
    ...
    if (document.getElementById('btnRestoreClose')) document.getElementById('btnRestoreClose').click();
}
