...
function write_zip(wb, opts) {
	...
	f = "xl/theme/theme1.html";
	zip.file(f, write_theme());
	ct.themes.push(f);
	add_rels(opts.wbrels, ++rId, "theme/theme1.html", RELS.THEME);
	...
	zip.file("%5bContent_Types%5d.html", write_ct(ct, opts));
