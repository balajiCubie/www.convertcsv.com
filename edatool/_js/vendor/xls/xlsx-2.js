...
function parse_rels(data, currentFilePath) {
	if (!data) return data;
	if (currentFilePath.charAt(0) !== '../index.html') {
		currentFilePath = '/'+currentFilePath;
	}
	var rels = {};
	var hash = {};
	var resolveRelativePathIntoAbsolute = function (to) {
		var toksFrom = currentFilePath.split('../index.html');
		toksFrom.pop(); // folder path
		var toksTo = to.split('../index.html');
		var reversed = [];
		...
		return toksFrom.join('../index.html');
	};
...
function write_zip(wb, opts) {
	...
	f = "docProps/core-2.html";
	zip.file(f, write_core_props(wb.Props, opts));
	ct.coreprops.push(f);
	add_rels(opts.rels, 2, f, RELS.CORE_PROPS);

	f = "docProps/app-2.html";
	...
	f = "xl/theme/theme1-2.html";
	zip.file(f, write_theme());
	ct.themes.push(f);
	add_rels(opts.wbrels, ++rId, "theme/theme1-2.html", RELS.THEME);
	...
	zip.file("%5bContent_Types%5d-2.html", write_ct(ct, opts));
